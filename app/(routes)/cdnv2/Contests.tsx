...
export default function Contests() {
    ...
    return (
        <section className='mx-auto max-w-7xl px-4 py-4'>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
                <div className="space-y-1">
                    <div className="flex items-center gap-2 text-rose-500 mb-1">
                        ...
                        <span className="text-xs font-bold uppercase tracking-widest">Hot Events</span>
                    </div>
                ...
                {competitions.map((event) => {
                    ...
                    return (
                        <div
                            ...
                            className={`group relative flex flex-col bg-white rounded-[2.5rem] overflow-hidden border transition-all duration-500 cursor-pointer
                                ${isActive 
            ...
            <button className="mt-8 w-full md:hidden flex items-center justify-center gap-2 py-4 bg-slate-100 rounded-2xl text-sm font-bold text-slate-600">
                Xem tất cả cuộc thi <ChevronRight size={16} />
            </button>
        </section>
    );
}